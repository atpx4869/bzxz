...
const ALL_TABS = ['search', 'labr', 'check', 'batch', 'complete', 'local', 'history', 'qual', 'cma-diff', 'logs', 'stats', 'settings'] as const;
export { ALL_TABS };
  ...
  router.put('/settings', async (req, res, next) => {
    try {
      const schema = z.object({
        ...
        defaultAllowedTabs: z.array(z.enum(['search', 'labr', 'check', 'batch', 'complete', 'local', 'history', 'qual', 'cma-diff', 'logs', 'stats', 'settings'])).nullable().optional(),
  ...
  router.post('/users', async (req, res, next) => {
    try {
      const schema = z.object({
        ...
        allowedTabs: z.array(z.enum(['search', 'labr', 'check', 'batch', 'complete', 'local', 'history', 'qual', 'cma-diff', 'logs', 'stats', 'settings'])).nullable().optional(),
      });
