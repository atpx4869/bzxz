...
var TAB_LABELS = {search:'标准检索',labr:'Labr库检索',batch:'批量下载',complete:'标准补全',local:'本地文件库',history:'下载历史',qual:'资质查询',logs:'运行日志',stats:'使用统计',users:'用户管理',settings:'系统设置',me:'我'};
